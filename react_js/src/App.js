...
function App() {
	...
	return (
		<Container className="!pl-0 !pr-0 overflow-auto" sx={{ maxWidth: '1440px' }} maxWidth={false}>
			<div className="h-full w-full flex flex-wrap  min-h-[1040px] md:min-h-0" style={{ padding: '50px 50px 40px' }}>
				<div className="w-full h-1/2 md:h-2/3 lg:w-2/3 lg:h-full min-h-[1100px] sm:min-h-[740px]">
					<div className="w-full sm:h-1/2 min-h-[300px]">
						{getCityWeather(main_city) ? (
							<div className="flex h-full bg-[url('../public/images/bg4.jpg')] bg-no-repeat bg-cover bg-left-top rounded-3xl min-h-[400px] md:min-h-0" style={{ boxShadow: '5px 10px 20px 0 rgba(0,0,0,0.17)' }}>
								<WeatherDayBox
									customStyle={{ margin: 'auto -50px', height: '280px', width: '140px', borderRadius: '0 25px 25px 0', maxWidth: 345, background: 'linear-gradient(180deg, #5374E7 0%, #77B9F5 100%)', boxShadow: '5px 10px 20px 0 rgba(0,0,0,0.17)' }}
							...
							<div className="bg-[url('../public/images/bg4.jpg')] bg-no-repeat bg-cover bg-left-top rounded-3xl" style={{ boxShadow: '5px 10px 20px 0 rgba(0,0,0,0.17)' }} />
						)}
					</div>
				...
				<div className="w-full h-1/2 md:h-1/3 lg:w-1/3 lg:h-full md:min-h-[800px] min-w-[160px]">
					<div className="w-full sm:h-1/2 flex flex-col">
						<Button
							className="!p-[40px] w-full flex-grow"
					...
					<div className="w-full sm:h-1/4 flex flex-col">
						...
						<div className="flex-grow h-full pl-7 pr-7 pt-3">
							<Card className='h-full bg-white !rounded-[25px]' style={{ boxShadow: 'box-shadow: 5px 10px 20px 0 rgba(0,0,0,0.17)' }}>
								<CardActionArea className='h-full'>
									<CardContent className='h-full flex flex-row !pt-0' sx={{ padding: '20px 0px 0px' }}>
										<input className="w-full p-7" placeholder="ex Miami" style={{ outlineColor: 'white'}}/>
